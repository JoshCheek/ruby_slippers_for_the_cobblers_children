...
import ruby4.Interpreter;
import ruby4.World;
// import ruby4.InternalMap;
// import ruby4.Errors;

using ruby4.LanguageGoBag;
...
class InterpreterSpec {
  public static function describe(d:spaceCadet.Description) {
    ...
    d.describe('ruby4.Interpreter', function(d) {
      ...
      //   a.eq('A', ruby4.World.sinspect(aClass));      // name
