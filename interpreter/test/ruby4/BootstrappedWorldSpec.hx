...
class BootstrappedWorldSpec {
  ...
  public static function describe(d:spaceCadet.Description) {
    d.describe('A bootstrapped world', function(d) {
      var world : ruby4.World;

      d.before(function(a) {
        world = ruby4.Bootstrap.bootstrap();
      });
      ...
      d.context('Object hierarchy', function(d) {
        function assertClassDef(a:spaceCadet.Asserter, self:RClass, name:String, superclass:RClass, world:ruby4.World) {
          a.eq(name,          self.name);
