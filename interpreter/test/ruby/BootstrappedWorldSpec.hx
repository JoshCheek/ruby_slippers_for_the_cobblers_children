...
class BootstrappedWorldSpec {
  static function assertInObjectSpace(a:spaceCadet.Asserter, obj:RObject, world:ruby.World, ?pos:haxe.PosInfos):Void {
    var found = null;
  ...
  public static function describe(d:spaceCadet.Description) {
    var worldDs     : ruby.ds.World;
    var world       : ruby.World;
    var interpreter : ruby.Interpreter;

    d.before(function(a) {
      worldDs     = ruby.Bootstrap.bootstrap();
