...
import  ruby2.ds.Errors;
import  ruby2.ds.Interpreter;
using   ruby2.LanguageGoBag;
using   Lambda;

class Interpreter {
  public  var state:ruby2.ds.Interpreter;
  private var world:ruby2.World;
  ...
  public function new(world:ruby2.World, state:ruby2.ds.Interpreter) {
    this.world = world;
    this.state = state;
  }
